...
user_table_insert = ("INSERT INTO users (user_id,first_name,last_name,gender,level) \
                 ...
                 (user_id,first_name,last_name, gender, level) = (EXCLUDED.user_id, EXCLUDED.first_name, EXCLUDED.last_name, EXCLUDED.gender, EXCLUDED.level)\
                ")
...
artist_table_insert = ("INSERT INTO artists (artist_id, artist_name, artist_location, artist_latitude, artist_longitude) \
                 ...
                 (artist_name,artist_location, artist_latitude, artist_longitude)= (EXCLUDED.artist_name, EXCLUDED.artist_location, EXCLUDED.artist_latitude, EXCLUDED.artist_longitude)\
                 ")
